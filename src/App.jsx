...
function LyricsView({ T, song, elapsed, duration, playing }) {
    ...
    <GlassPanel T={T} className="p-5">
      ...
      {estado === "ok" && (
        <div
          ...
          className="whitespace-pre-line text-center leading-relaxed text-[15px] font-semibold"
          style={{ color: T.text, maxHeight: 340, overflowY: "auto", scrollBehavior: "smooth" }}
        >
          {letra}
        </div>
      )}
  ...
  return (
    <div className="min-h-full w-full flex flex-col relative" style={{ background: T.bg, color: T.text }}>
      ...
      <div className="relative flex-1 overflow-y-auto px-4 pt-4">
        ...
        {screenMode === "letras" && <LyricsView T={T} song={currentSong} elapsed={elapsed} duration={duration} playing={playing} />}
