...
function LyricsView({ T, song, elapsed, duration, playing, audioSource }) {
  const spotifyHabilitado = audioSource === "spotify";
  ...
  }, [elapsed, duration, estado, playing]);
  ...
  return (
    <div className="min-h-full w-full flex flex-col relative" style={{ background: T.bg, color: T.text }}>
      ...
      <div className="relative flex-1 overflow-y-auto px-4 pt-4">
        ...
        {screenMode === "letras" && <LyricsView T={T} song={currentSong} elapsed={elapsed} duration={duration} playing={playing} audioSource={audioSource} />}
