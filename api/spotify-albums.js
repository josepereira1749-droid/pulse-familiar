export default async function handler(req, res) {
  try {
    ...
    let albumsCrudos = [];
    let siguienteUrl = `https://api.spotify.com/v1/artists/${artistaEncontrado.id}/albums?include_groups=album,single&limit=50`;
    let paginas = 0;

    while (siguienteUrl && paginas < 10) { // tope de seguridad: hasta 500 álbumes/sencillos
